...
DATA_BASE = "/workspaces/build-your-first-agent-with-azure-ai-agent-service-workshop/src/workshop/database/contoso-sales.db"
...
class SalesData:
    ...
    async def connect(self: "SalesData") -> None:
        ...
        try:
            ...
            logger.exception("An error occurred while connecting to the database", exc_info=e)
            self.conn = None
